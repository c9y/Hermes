package cc.zeala.hermes;

import cc.zeala.hermes.commands.admin.*;
import cc.zeala.hermes.commands.player.*;
import cc.zeala.hermes.commands.staff.ClearChatCommand;
import cc.zeala.hermes.commands.staff.FreezeCommand;
import cc.zeala.hermes.commands.staff.MuteChatCommand;
import cc.zeala.hermes.commands.staff.StaffChatCommand;
import cc.zeala.hermes.manager.PlayerManager;
import cc.zeala.hermes.profile.ProfileListener;
import cc.zeala.hermes.punishments.PunishmentManager;
import cc.zeala.hermes.punishments.command.*;
import cc.zeala.hermes.punishments.listener.PunishmentListener;
import cc.zeala.hermes.staff.freeze.Listener.ListenerHandler;
import cc.zeala.hermes.staff.freeze.ManagerHandler;
import cc.zeala.hermes.task.ShutdownTask;
import cc.zeala.hermes.utils.finalutil.PlayerEvents;
...
public class Hermes extends JavaPlugin implements Listener {
    ...
    private cc.zeala.hermes.database.Database Database;
    @Getter
