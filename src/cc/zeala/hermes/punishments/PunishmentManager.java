package cc.zeala.hermes.punishments;

import cc.zeala.hermes.Hermes;
import cc.zeala.hermes.utils.Duration;
...
public class PunishmentManager {
    ...
    public PunishmentManager(final Hermes plugin) {
        this.nextId = 1;
        ...
        this.threadId = Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
            @Override
            public void run() {
                try {
